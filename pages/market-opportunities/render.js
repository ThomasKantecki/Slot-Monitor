...
export function renderOpportunities(specialtyId = "cardiology") {
  ...
  const counties = readJson("data/geography/fl-county.geojson"), zips = readJson("data/geography/fl-zcta.geojson"), outline = readJson("data/geography/florida-outline.geojson");
...
<section class="workspace"><article class="panel map-panel"><div class="band"><h2 id="map-title">__LABEL__ markets</h2><span id="map-meta" class="band-meta"></span></div><div class="map-wrap"><div class="hint">Scroll to zoom &middot; drag to pan &middot; click for markets</div><svg id="map" viewBox="0 0 1000 940" role="img" tabindex="0" aria-label="Florida __LABEL_LOWER__ market map"><g id="map-vp"></g></svg><canvas id="map-raster" width="1000" height="940" aria-hidden="true"></canvas><div class="legend"><div class="legend-row"><span class="swatch dot oh"></span>Orlando Health leads the market</div><div class="legend-row"><span class="swatch dot gap"></span>No AdventHealth slots in the ZIP</div><div class="legend-row"><span class="swatch dot ah"></span>AdventHealth leads</div></div><div class="zoom"><button id="zoom-in" aria-label="Zoom in">+</button><button id="zoom-out" aria-label="Zoom out">−</button><button id="zoom-reset" aria-label="Reset map" style="font-size:12px">&#8634;</button></div></div></article>
 <aside class="side"><article class="card summary"><div id="summary-overview"><div class="summary-band"><h2 id="area-name" class="summary-title">—</h2></div><div class="summary-rows"><div class="summary-row oh"><span class="row-label">Markets where Orlando Health leads</span><div class="summary-figure"><div id="kpi-coverage" class="n">—</div></div></div><div class="summary-rule thin"></div><div class="summary-row oh"><span class="row-label">ZIPs with no AdventHealth slots</span><div class="summary-figure"><div id="kpi-priority" class="n">—</div></div></div><div class="summary-rule thin"></div><div class="summary-row"><span class="row-label">Markets booking a week or more sooner at Orlando Health</span><div class="summary-figure"><div id="kpi-earlier" class="n">—</div></div></div><div class="summary-rule thin"></div><div class="summary-row"><span class="row-label">Largest Orlando Health lead</span><div class="summary-figure"><div id="kpi-slot-gap" class="n">—</div><div id="kpi-slot-gap-sub" class="s">—</div></div></div></div><div id="area-lead" class="lead">—</div></div><div id="summary-market" hidden><div class="summary-band"><h2 id="market-name" class="summary-title">—</h2><span id="market-rank" class="summary-meta">—</span></div><div class="summary-rows"><div class="summary-row oh"><span class="tlogo oh" role="img" aria-label="Orlando Health"></span><div class="summary-figure"><div id="market-oh" class="n">—</div><div id="market-oh-sub" class="s">—</div></div></div><div class="summary-rule"></div><div class="summary-row ah"><span class="tlogo ah" role="img" aria-label="AdventHealth"></span><div class="summary-figure"><div id="market-ah" class="n">—</div><div id="market-ah-sub" class="s">—</div></div></div></div><div class="summary-facts"><div class="fact"><span class="fact-n pair dates"><span id="market-earliest-oh" class="oh">—</span><small>OH</small><span id="market-earliest-ah" class="ah">—</span><small>AH</small></span><span class="fact-t">Earliest appointment</span></div><div class="fact"><span id="market-nearest" class="fact-n">—</span><span class="fact-t">Nearest AdventHealth</span><span id="market-nearest-sub" class="fact-s">—</span></div></div><div id="market-reasons" class="reasons"></div><div id="market-lead" class="lead">—</div><div class="summary-actions"><button id="open-market" class="plain" type="button">Facilities and providers</button><button id="back-overview" class="plain" type="button">Back to overview</button></div></div></article><article class="panel rank-panel"><div class="band"><h2>Ranked markets</h2><span id="market-count" class="band-meta"></span></div><div id="market-table" class="rank-list"></div></article></aside>
</section>
</main>
