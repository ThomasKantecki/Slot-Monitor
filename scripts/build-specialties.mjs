...
// src/shared/specialty-placeholders.js, which `npm run build` runs right after this script. Each step is run
// once per specialty with `--specialty <id>`, so the individual npm scripts keep working unchanged.
import { spawnSync } from "node:child_process";
import { existsSync } from "node:fs";
import { join } from "node:path";
import { pathToFileURL } from "node:url";
import { ROOT, SPECIALTIES, specialtyPaths } from "../src/shared/specialties.js";

const STEPS = [
  "scripts/build-slot-times-data.mjs",
  "scripts/build-slot-partitions.mjs",
  "src/render.js",
  "src/slot-times/render.js",
