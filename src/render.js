...
.sub-specialty{display:inline-flex;align-items:center;gap:6px;margin-left:8px}.sub-specialty[hidden]{display:none}.sub-specialty select.control{width:150px;max-width:150px;text-overflow:ellipsis}
