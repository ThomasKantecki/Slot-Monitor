...
.geography-controls{flex:1 1 300px;min-width:0}.geography-controls .control-section-body{flex-wrap:nowrap}.geography-controls .search-stack{flex:1 1 150px;min-width:0}.geography-controls .fgroup,.geography-controls input.control{width:100%;max-width:none;min-width:96px}
...
.subspecialty-controls{flex:0 0 auto}.subspecialty-controls[hidden]{display:none}.subspecialty-controls select.control{width:196px;max-width:196px;text-overflow:ellipsis}
...
@media (max-width:480px){
 ...
 .fgroup{width:100%;justify-content:space-between}.fgroup select.control,.subspecialty-controls select.control{flex:1;width:auto;max-width:none}
}
