...
<section class="workspace"><article class="panel map-panel"><div class="band"><h2 id="map-title">Physical appointments per ZIP code</h2><span id="map-meta" class="band-meta"></span></div><div class="map-wrap"><svg id="map" viewBox="0 0 1000 940" role="img" aria-label="Florida physical appointment availability map"><defs><pattern id="tie-pattern" width="10" height="10" patternUnits="userSpaceOnUse" patternTransform="rotate(45)"><rect width="5" height="10" fill="#1a75aa"></rect><rect x="5" width="5" height="10" fill="#b20838"></rect></pattern></defs><g id="map-vp"></g></svg><canvas id="map-raster" width="1000" height="940" aria-hidden="true"></canvas><div class="legend"><div class="legend-row"><span class="swatch ah"></span>More AdventHealth</div><div class="legend-row"><span class="swatch tie"></span>Equal</div><div class="legend-row"><span class="swatch oh"></span>More Orlando Health</div></div><div class="zoom"><button id="zoom-in" aria-label="Zoom in">+</button><button id="zoom-out" aria-label="Zoom out">−</button><button id="zoom-reset" aria-label="Reset map">↻</button></div></div></article>
 <aside class="side"><article class="card summary"><div id="area-name" class="summary-title">—</div><div class="compare"><div class="compare-box ah"><div id="kpi-ah" class="n">—</div><div class="t">AdventHealth appointments</div><div id="kpi-ah-sub" class="s">Available appointment slots</div></div><div class="compare-box oh"><div id="kpi-oh" class="n">—</div><div class="t">Orlando Health appointments</div><div id="kpi-oh-sub" class="s">Available appointment slots</div></div><div class="compare-box"><div id="kpi-providers" class="n">—</div><div class="t">Available providers</div><div id="kpi-period" class="s">—</div></div><div class="compare-box"><div class="n pair"><span id="kpi-facilities-ah" class="ah">—</span><small>AH</small><span id="kpi-facilities-oh" class="oh">—</span><small>OH</small></div><div class="t">Facilities with slots</div><div id="kpi-dates" class="s">—</div></div></div><div id="area-lead" class="lead">—</div></article><article class="panel profile-panel"><div class="band"><h2>Availability profile</h2></div><div class="profile-heading">Bookable appointments by date</div><div id="availability-profile" class="availability-profile"></div></article></aside>
</section>
