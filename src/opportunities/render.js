...
<section class="toolbar op-toolbar" aria-label="Market opportunity filters">
 ...
 <fieldset class="filter-group opportunity-group"><legend>Opportunity</legend><div class="filter-group-body"><div class="control-stack"><label class="label" for="opportunity-filter">Show markets</label><select id="opportunity-filter" class="field"><option value="all">All opportunity signals</option><option value="high">High priority (50+)</option><option value="coverage">Priority exact-ZIP gaps</option><option value="earlier">OH earliest is sooner</option><option value="slots">OH has more slots</option></select></div></div></fieldset>
...
<section class="kpis" aria-label="Opportunity summary"><article class="card kpi"><div class="kpi-label">Priority exact-ZIP gaps</div><div id="kpi-priority" class="kpi-value oh">—</div><div class="kpi-sub">OH has slots, AH has none, and OH leads the 25-mile market</div></article><article class="card kpi"><div class="kpi-label">OH-leading local markets</div><div id="kpi-coverage" class="kpi-value oh">—</div><div class="kpi-sub">25-mile markets where OH has more slots than AH</div></article><article class="card kpi"><div class="kpi-label">OH earlier access</div><div id="kpi-earlier" class="kpi-value">—</div><div class="kpi-sub">OH-leading markets where OH's earliest date is sooner</div></article><article class="card kpi"><div class="kpi-label">Largest OH slot advantage</div><div id="kpi-slot-gap" class="kpi-value">—</div><div class="kpi-sub">Largest OH lead in one 25-mile market</div></article></section>
<section class="opportunity-workspace"><article class="panel opportunity-map-panel"><div class="band"><h2 id="map-title">Cardiology opportunity signals</h2><span id="map-meta" class="band-meta"></span></div><div class="map-wrap"><svg id="map" viewBox="0 0 1000 940" role="img" tabindex="0" aria-label="ZIP-centered 25-mile Florida cardiology markets where Orlando Health leads AdventHealth. Maroon exact-ZIP markers require both an AH absence in the ZIP and an Orlando Health lead in the surrounding market. Drag to pan, use the mouse wheel to zoom, or use arrow keys to pan."><g id="map-vp"></g></svg><div class="op-legend"><div><span class="op-dot coverage"></span>Priority exact ZIP: AH absent · OH leads locally</div><div><span class="op-dot lead"></span>25-mile market: AH present · OH leads</div><div class="legend-size">Marker size = opportunity score · maroon core inside coral = both</div></div><div class="zoom"><button id="zoom-in" aria-label="Zoom in">+</button><button id="zoom-out" aria-label="Zoom out">−</button><button id="zoom-reset" aria-label="Reset map">↻</button></div></div></article>
 <aside class="opportunity-side"><article class="panel evidence-panel"><div class="band"><h2>Selected market evidence</h2><span class="band-meta">Click a marker or table row</span></div><div id="market-evidence" class="market-evidence"><div class="evidence-empty">Select a market center to review exact-ZIP and nearby-market evidence.</div></div></article><article class="card methodology"><h2>How priority is scored</h2><div class="weight-list"><span><b>35</b> AH coverage gap</span><span><b>25</b> OH timing advantage</span><span><b>20</b> OH slot advantage</span><span><b>10</b> Persistent OH lead</span><span><b>10</b> Distance to active AH access</span></div><p>Maroon markers require both a same-ZIP AH gap and an OH lead across the surrounding 25-mile market. Coral markers compare every active AH and OH facility within 25 miles of the represented ZIP center. Exact ZIP gaps where AH leads locally remain evidence only; they do not receive a priority marker. The Radius control changes which centers are shown, not the 25-mile comparison. Overlapping markets can contain the same slots, so market counts should not be summed. This is a prioritization signal—not patient demand or market share.</p></article></aside>
</section>
