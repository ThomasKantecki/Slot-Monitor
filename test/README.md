...
| `extractor.test.js` | The Python scripts compile and dry-run for every specialty; the paging loop and the questionnaire walker survive scripted Epic behaviours (`extractor/paging_check.py`, `walk_check.py`); deduplication; run selection. |
